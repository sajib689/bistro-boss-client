        ...
        <div className="hero-content flex-col md:flex lg:flex-row">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center mb-3">
              <img className="p-2 ms-2 mt-3 border border-black rounded-[50%]" src={facebook} alt="" />
              <img className="p-2 ms-2 mt-3 border border-black rounded-[50%]" src={google} alt="" />
              <img className="p-2 ms-2 mt-3 border border-black rounded-[50%]" src={github} alt="" />
            </div>
          </div>
          </div>
        </div>
